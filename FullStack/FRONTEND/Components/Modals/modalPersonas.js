export function ModalPersonas() {
  let body = document.querySelector("body");

  let div = document.createElement("div");
  div.setAttribute("class", `modal fade`);
  div.setAttribute("id", "modalPersonas");
  div.setAttribute("data-bs-backdrop", "static");
  div.setAttribute("data-bs-keyboard", "false");
  div.setAttribute("tabindex", "-1");
  div.setAttribute("aria-labelledby", "modalPersonasLabel");
        ...
        <div class="row g-3">
          ...
          <div class="col-12">
            ...
            <select
              ...
              required
            >
              <option selected>Seleccione sexo de la Persona</option>
